          ...
          <TooltipTrigger asChild>
            <DialogTrigger asChild>
              <Button variant="ghost" size="icon" className="hover:bg-transparent">
                <div className="flex items-center justify-center h-7 w-7 rounded-sm bg-orange-500 transition-transform ease-in-out hover:scale-125">
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
            ...
            <DialogFooter>
              ...
              <Button type="submit" className="font-bold text-white bg-[#4DAA57] hover:bg-[#4DAA57]/90">Save Changes</Button>
            </DialogFooter>
          </form>
        </Form>
      </DialogContent>
